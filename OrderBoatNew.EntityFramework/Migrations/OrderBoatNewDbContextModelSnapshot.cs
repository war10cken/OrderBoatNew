...
namespace OrderBoatNew.EntityFramework.Migrations
{
    ...
    partial class OrderBoatNewDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderBoatNew.Domain.Models.Account", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OrderBoatNew.Domain.Models.Account", b =>
                {
                    b.HasOne("OrderBoatNew.Domain.Models.Invoice", "Invoice")
                        .WithMany()
                    ...
                    b.HasOne("OrderBoatNew.Domain.Models.User", "AccountHolder")
                        .WithMany()
