...
namespace OrderBoatNew.EntityFramework.Services.Common
{
    public class NonQueryDataService<T> where T : DomainObject
    {
        private readonly OrderBoatNewDbContextFactory _contextFactory;

        public NonQueryDataService(OrderBoatNewDbContextFactory contextFactory) { _contextFactory = contextFactory; }
